...
const dict = {
  en: {
    ...
    view: "View",
    editAccess: "Edit",
    noShared: "Not shared with anyone.",
    ...
    noFamily: "No family yet — create or join one to share budgets with loved ones.",
    familyHint: "Share one budget with your household. Same transactions, budgets, goals for all members.",
    member: "Member",
    allMembers: "All members",
    selectMember: "Select member",
    addMemberHint: "Who spent? e.g. Mom, Dad, Kid",
  },
  uk: {
    ...
    checking: "Поточний",
    savings: "Накопичувальний",
    cash: "Готівка",
    credit: "Кредитний",
    investment: "Інвестиційний",
    totalBalance: "Загальний баланс",
    noAccounts: "Рахунків ще немає.",
    addRecurring: "Додати рекурентну",
    frequency: "Частота",
    daily: "Щодня",
    weekly: "Щотижня",
    monthly: "Щомісячно",
    ...
    active: "Активна",
    inactive: "Неактивна",
    noRecurring: "Рекурентних транзакцій немає.",
    ...
    upcoming: "Найближчі",
    noUpcoming: "Найближчих нагадувань немає.",
    addTag: "Додати мітку",
    tagName: "Назва мітки",
    color: "Колір",
    noTags: "Міток ще немає.",
    shareWith: "Поділитися з email",
    permission: "Дозвіл",
    view: "Перегляд",
    editAccess: "Редагування",
    noShared: "Нікому не надано доступу.",
    categoryTrends: "Тренди по категоріях",
    ...
    joinFamily: "Приєднатися",
    inviteCode: "Код запрошення",
    copyCode: "Копіювати",
    copied: "Скопійовано!",
    members: "Учасники",
    leaveFamily: "Вийти з сім'ї",
    noFamily: "Ще немає сім'ї — створіть або приєднайтесь, щоб вести спільний бюджет.",
    familyHint: "Одна сім'я — спільні транзакції, бюджети та цілі для всіх.",
    member: "Член сім'ї",
    allMembers: "Всі",
    selectMember: "Оберіть учасника",
    addMemberHint: "Хто витратив? Напр. Мама, Тато, Дитина",
  },
} as const;
